          ...
          <div class="grid gap-4 sm:grid-cols-2">
            ...
            <a href="{{ route('giata.properties.raw.index') }}"
              ...
              <div class="flex items-center gap-3">
                ...
                <div class="flex-1">
                  <div class="flex items-center justify-between">
                    <h2 class="text-sm font-medium text-slate-900">GIATA – Propiedades (CSV)</h2>
                    <svg class="h-4 w-4 text-slate-400 transition group-hover:text-slate-600" fill="currentColor"
                      viewBox="0 0 20 20">
                      <path fill-rule="evenodd"
                        d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707A1 1 
                        0 118.707 5.293l4 4a1 1 0 010 1.414l-4 4a1 1 
                        0 01-1.414 0z"
                        clip-rule="evenodd" />
                    </svg>
                  </div>
                  <p class="mt-1 text-xs text-slate-600">
                    Consulta las propiedades GIATA importadas del CSV (coords, address, emails…).
                  </p>
                </div>
              </div>
            </a>
            ...
            <a href="{{ route('availability.form') }}" class="group rounded-lg border border-slate-200 bg-white p-4 hover:shadow-sm hover:border-slate-300 transition">
              <div class="flex items-center gap-3">
                <span class="inline-flex h-8 w-8 items-center justify-center rounded-md bg-blue-50 ring-1 ring-blue-100">
                  <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-blue-600" fill="none" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.6"
                  ...
                  <div class="flex items-center justify-between">
                    ...
                    <svg class="h-4 w-4 text-slate-400 group-hover:text-slate-600 transition" fill="currentColor" viewBox="0 0 20 20">
                      <path fill-rule="evenodd"
                        ...
                        7.293 6.707A1 1 0 118.707 5.293l4 4a1 1 
            ...
            <a href="{{ route('itravex.status') }}" class="group rounded-lg border border-slate-200 bg-white p-4 hover:shadow-sm hover:border-slate-300 transition">
              <div class="flex items-center gap-3">
