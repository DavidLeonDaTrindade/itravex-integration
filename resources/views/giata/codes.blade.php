...
<style>
  ...
  .pb-btn-ghost {
    ...
    border: 1px solid rgba(0, 70, 101, .10);
  }
  ...
  /* Dropdown providers (igual pero con look pb) */
  .pb-suggest {
  ...
  /* Dropdown providers: más aire + contraste */
  #provDropdown {
  ...
  /* Subtexto (code) un poco más suave */
  #provOptions li .prov-meta {
    color: #475569;
    /* slate-600 */
    font-weight: 500;
  }
  ...
  /* Cuando NO está seleccionado, que no ocupe espacio */
  #provOptions li .prov-check.is-off {
    display: none;
  }
</style>
...
<x-app-layout>
  <div class="min-h-screen bg-slate-50 py-10">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <div class="mx-auto rounded-2xl p-8" style="background:#e2e8f0; border:1px solid #cbd5e1;">
      ...
      <div class="pb-card" style="background:#cbd5e1;">
        <div class="pb-card-body">
              ...
              <div class="flex flex-col gap-2 w-full md:w-[420px]">
                <div class="flex items-center gap-2">
                  <input id="hotelSearch"
                    ...
                    class="pb-input flex-1 min-w-0" />

                  <button id="clearHotel"
                    type="button"
                    class="pb-btn pb-btn-ghost whitespace-nowrap">
                    Limpiar
                  </button>
                </div>
          ...
          <div class="flex flex-col md:flex-row items-start md:items-center gap-10 mt-4">
            <div class="flex flex-col gap-2 w-full md:w-auto">
              ...
              <div class="relative w-full min-w-[320px]">
                ...
                <div id="provDropdown"
                  class="hidden absolute z-30 mt-2 w-full pb-suggest max-h-60 overflow-auto">
                  <ul id="provOptions" class="text-sm"></ul>
                </div>
              </div>
            ...
            <div class="flex flex-col gap-1 w-full md:w-[340px]">
              <div class="flex items-center justify-between gap-2">
                ...
                <button id="clearGiata" type="button"
                  class="pb-btn pb-btn-ghost !py-1 !px-2 text-[11px]">
                  Limpiar GIATA
                </button>
              </div>
              <textarea id="giataFilter"
                ...
                class="pb-textarea text-[11px]">@if(!empty($giataIdsString)){{ $giataIdsString }}@endif</textarea>
              <small class="text-[11px] text-slate-500">
          ...
          <div class="mt-4 overflow-auto pb-table-wrap">
          ...
          <div class="mt-4 flex items-center justify-between text-sm">
            ...
            <div class="flex gap-2">
              <button id="btnExport" type="button" class="pb-btn pb-btn-primary">
                Exportar Excel
              </button>

              <button id="prevBtn" class="pb-btn pb-btn-ghost disabled:opacity-50">Anterior</button>
              <button id="nextBtn" class="pb-btn pb-btn-ghost disabled:opacity-50">Siguiente</button>
            </div>
          </div>
    ...
    <script>
      (function() {
        ...
        function createCodeCell(rawValue) {
          ...
          td.className = 'pb-td align-top whitespace-nowrap';
          ...
          wrap.className = 'inline-block align-top';
  ...
  <div>
    ...
    <div class="text-xs prov-meta">${code}</div>
  </div>
  <span class="prov-check ${isSelected(code) ? '' : 'is-off'}">✓</span>
`;
